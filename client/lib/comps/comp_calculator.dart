...
class CompCalculator extends StatelessWidget {
  CompCalculator({Key? key, this.defaultValue, required this.onChange}) : super(key: key);
        ...
        children: [
          ...
          Flexible(
            child: GridButton(
              ...
              onPressed: (apa) {
                if (apa == "0") {
                  if (paymentValue.value.isEmpty) {
                    paymentValue.value = "0";
                  } else {
                    paymentValue(paymentValue.value + "0");
                  }
                } else if (apa == "del") {
                  if (paymentValue.value.isNotEmpty) {
