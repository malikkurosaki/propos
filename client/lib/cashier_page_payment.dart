import 'package:client/cashier_page_payment_finish.dart';
...
class CashierPagePayment extends StatelessWidget {
  ...
  onload() {
    if (UtilPref.billId.value.isEmpty) {
      UtilPref.billIdSet(value: Uuid().v4());
    }
  }
                                          ...
                                          Container(
                                            ...
                                            child: Text(
                                              NumberFormat.currency(locale: "id_ID", symbol: "")
                                                  .format(
                                                      int.parse(paymentValue.value.isEmpty ? "0" : paymentValue.value))
                                                  .replaceAll(",00", ""),
                                              style: TextStyle(
