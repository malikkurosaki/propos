                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              children: [
                                CircleAvatar(backgroundColor: Colors.orange, child: BackButton(color: Colors.white,)),
                                Padding(
                                  padding: const EdgeInsets.symmetric(horizontal: 8),
                                  child: Text("Favorite", style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold)),
                                ),
                              ],
                            ),
                          ),
                                                      ...
                                                      child: Align(
                                                        ...
                                                        child: IconButton(
                                                          onPressed: () {
                                                            ...
                                                            UtilPref.listFavoriteSet(value: UtilPref.listFavorite.toList());
                                                          },
                                                          icon: CircleAvatar(
                                                            backgroundColor: Colors.white,
                                                            child: Icon(
